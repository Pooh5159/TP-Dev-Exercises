...
<body>
    <div class="text-center">
        ...
        <div>
            <a href="2.php">2. Trouver la bonne form’ule</a>
        </div>
        <div>
            <a href="3.php">3. Ce n’est pas une si simple form’alité</a>
        </div>
        <div>
            <a href="4.php">4. Au delà de votre parcours de form’ation</a>
        </div>
    </div>
</body>
